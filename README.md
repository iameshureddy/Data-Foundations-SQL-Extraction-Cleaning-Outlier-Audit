...
---
## 2. Dataset### Olist Brazilian E-Commerce Dataset
...
---
# 6. Task 1 – Relational Database Setup### Files
```text
...
---
# 7. Task 2 – Basic SQL Queries### File
```text
...
---
# 8. Task 3 – GROUP BY and HAVING### File
```text
...
---
# 11. Task 6 – Export JOIN Result to CSV### File
```text
...
---
# 19. How to Run the Project## Step 1 – Clone the repository
```bash
...
---
# 22. Final Results## Database and JOIN
```text
Database    : smartcommerce_analytics
JOIN rows   : 99,441
JOIN columns: 6
